...
function renderChart(teamData, y, m, isP2) {
    ...
    window.myChart = new Chart(ctx, {
        ...
        options: {
            responsive: true, maintainAspectRatio: false, // PENTING AGAR TIDAK GEPENG
            scales: { y: { beginAtZero: true, grid: {color:'#333'}, ticks: {display: false} }, x: { grid: {display:false}, ticks: {color: '#888', fontSize: 9} } },
