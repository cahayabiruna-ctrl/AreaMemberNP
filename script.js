...
// ==========================================
// 5. DASHBOARD (LOGIKA TOTAL = SAYA + TIM)
// ==========================================
function renderDashboard() {
    ...
    // myTeamData isinya sudah [Saya, Anak, Cucu, ...]
    // Jadi cukup ambil panjang array-nya saja.
    const totalTeam = myTeamData.length; 
    
    document.getElementById('totalMembers').innerText = totalTeam;

    // HITUNG PERINGKAT (Pakai Total yg sudah termasuk saya)
    ...
    // Hitung Target dari myTeamData (Termasuk Saya)
