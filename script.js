...
// ==========================================
// 7. NETWORK (LOGIKA WARNA DIPERBAIKI DISINI)
// ==========================================
function initNetwork() {
    ...
    const nodes = myTeamData.map(m => {
        ...
        // --- PERBAIKAN LOGIKA WARNA EMAS ---
        // Syarat: Punya 5 Direct Downline (Downline yang Uplinenya adalah m.uid)
        // Kita cek di globalData (Database lengkap)
        const directDownlines = globalData.filter(sub => sub.upline === m.uid).length;
        const isGold = directDownlines >= 5;
